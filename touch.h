/*
  Handle the capacitive touch sensor above the nose on Bright Eyes. 
  This touch pad is just about visible inside the circuit board. It looks like a slightly raised 
